...
export const OptionListCheck = styled.div<{ isSelected?: boolean; checkbox?: boolean; singleSelection?: boolean }>`
  width: 22px;
  height: 22px; 
  border-radius: ${props => (props.checkbox ? '10%' : props.singleSelection ? '50%' : '0%')};
  ...
  &:after{
    ...
    border-radius: ${props => (props.checkbox || !props.singleSelection ? '0%' : '50%')}; 
